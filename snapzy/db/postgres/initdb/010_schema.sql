...
CREATE TABLE IF NOT EXISTS posts (
  ...
  caption TEXT, location_id BIGINT,
...
CREATE TABLE IF NOT EXISTS reels (
  ...
  sound_id BIGINT, chapters JSONB, transcript TEXT,
...
CREATE TRIGGER trg_moderation_cases_updated BEFORE UPDATE ON moderation_cases FOR EACH ROW EXECUTE PROCEDURE set_updated_at();
